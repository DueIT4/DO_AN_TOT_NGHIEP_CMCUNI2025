...
from app.services.detection_history_service import (
    ...
    _normalize_file_url,  # Thêm hàm normalize để dùng cho detail view
    UserNotFoundError,
...
def my_detection_history_detail(
    ...
    """
    Lấy chi tiết 1 bản ghi nhận diện bao gồm ảnh (URL Cloudinary/Local) và danh sách bbox.
    """
    # 1) tìm detection
    ...
    # 4) lấy tất cả detections của cùng 1 ảnh
    rows = (
    ...
    # 5) payload tổng - Sử dụng _normalize_file_url cho Cloudinary/Local
    ...
    return {
        ...
        # BẮT BUỘC dùng hàm normalize ở đây để xử lý link Cloudinary
        "img_url": _normalize_file_url(img.file_url), 
