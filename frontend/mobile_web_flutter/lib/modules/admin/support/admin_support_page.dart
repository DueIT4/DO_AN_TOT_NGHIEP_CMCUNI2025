    ...
    try {
      ...
      setState(() {
        ...
        if (_selectedTicket == null && _tickets.isNotEmpty) {
          ...
          final stillExists =
              _tickets.any((t) => t.ticketId == _selectedTicket!.ticketId);
                          ...
                          child: _tickets.isEmpty
                              ...
                              : ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final isActive =
                                        _selectedTicket?.ticketId == t.ticketId;
          ...
          child: detail == null
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isAdmin = sender.isEmpty || sender.contains('admin');

                    final align =
                        isAdmin ? Alignment.centerRight : Alignment.centerLeft;
                    final bubble =
                        isAdmin ? Colors.green.shade50 : Colors.grey.shade100;
